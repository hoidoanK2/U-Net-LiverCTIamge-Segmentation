...
def augment_data(images, masks, save_path, augment=True):
    ...
    for idx, (x, y) in tqdm(enumerate(zip(images, masks)), total=len(images)):
        ...
        dir_name = normalized_path.split(os.sep)[-3]
        ##  dir_name = x.split("/")[-3]
        name = dir_name + "_" + normalized_path.split(os.sep)[-1].split(".")[0]
...
if __name__ == "__main__":
    ...
    augment_data(train_x, train_y, r"D:\Liver160\new_data\train", augment=True)
    augment_data(valid_x, valid_y, r"D:\Liver160\new_data\valid", augment=False)
